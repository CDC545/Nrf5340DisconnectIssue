...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HCI_TX_STACK_SIZE, 8192);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_WORKQUEUE_PRIORITY, -3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_COUNT, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_MAX, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_FRAG_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_DYNAMIC_CHANNEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_PREPARE_COUNT, 10);
